...
pal <- palette(brewer.pal(n=5, name = "Reds"))
...
pal <- palette(brewer.pal(n=5, name = "Blues"))
...
pal <- palette(brewer.pal(n=5, name = "Oranges"))

ptest <- tryCatch(
plot(smallbnd4["est"], key.pos=1, axes=TRUE, key.width=lcm(1.3),
	graticule=TRUE, key.length=1.0, breaks="equal", nbreaks=5,
	pal=palette(brewer.pal(n=6, name="Oranges")),
	border="black", lwd=.5, main=""),
     	 	error=function(e) {
			return(NULL) })
