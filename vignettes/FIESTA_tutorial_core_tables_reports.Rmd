...
SQLitefn <- "F:/FIAdata/FIApublic_VT_evalAll_pop_20220519.db"
DBgetPlots(istree=TRUE, isseed=TRUE, 
          ...
          savePOP = TRUE, 
          savedata = TRUE, 
          othertables = c("POP_ESTN_UNIT", "POP_STRATUM"),  
...
```{r}
sqlitefn <- system.file("extdata", "FIA_data/FIApublic_VT_evalAll_pop_20220519.db", package="FIESTAnalysis")
